...
- `security_token` - (Optional) Security Token of Tencent Cloud for temporary access credentials. It supports environment variables `TENCENTCLOUD_SECURITY_TOKEN`.
